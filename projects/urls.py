...
urlpatterns = [
    ...
    path('<int:id>/', login_required(views.ProjectsStatisticsView.as_view(), redirect_field_name=LOGIN_URL), name='projectdetail'),
    ...
    path('<int:id>/statistics', login_required(views.ProjectsStatisticsView.as_view(), redirect_field_name=LOGIN_URL), name='projectstatisticsview'),
    # APIs
